/**
 * Obsidian Theme for Shiki
 *
 * This theme uses CSS variables that can be defined by Obsidian themes,
 * allowing syntax highlighting colors to automatically adapt to the active theme.
 *
